<?php
class Admin_Notice_model extends CI_Model {
	...
	function insert_notice($subject, $content, $mb_email, $type){
		$sql  = " INSERT INTO notice ( ";
		$sql .= " subject, content, reg_dt, update_dt, mb_email, del_yn, notice_type, read_cnt ";
		$sql .= " ) VALUES ( ";
		$sql .= "'" . $subject . "', ";
		$sql .= "'" . $content . "', ";
		$sql .= "NOW(), ";
	...
	function view_notice($seq){
		$sql  = " SELECT seq, subject, content, reg_dt, update_dt, mb_email, del_yn, notice_type, read_cnt ";
		$sql .= "   FROM notice ";
		$sql .= "  WHERE seq = '" .$seq. "'";
		$sql .= "    AND del_yn = 'N'";
	...
	function update_notice($seq, $subject, $content, $mb_email, $type){
		$sql  = " UPDATE notice set ";
		$sql .= "  subject = '" .$subject. "', ";
		$sql .= "  content = '" .$content. "', ";
		$sql .= "  update_dt = NOW() ";
		$sql .= "  WHERE seq =  '" .$seq. "'";
		$sql .= "    AND notice_type = '" .$type. "'";
	...
	function delete_notice($seq, $type){
		$sql  = " UPDATE notice set ";
		$sql .= "  del_yn = 'Y' ";
		$sql .= "  WHERE seq =  '" .$seq. "'";
		$sql .= "    AND notice_type = '" .$type. "'";
